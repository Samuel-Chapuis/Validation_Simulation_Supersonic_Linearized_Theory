...
\begin{center}
	{\large MAE 635 - Comp Fluid Dynamics II} % Subtitle: Slightly smaller
		\\[1.5cm]
		{\LARGE \textbf{Comparison of the different attached shock models}} % Title: Slightly larger and bold
		\\[0.5cm]
...
% \input{biblio/Biliography.tex}

% \bibliographystyle{plain}               % ← ajoute ceci AVANT \bibliography
